...
<body style="background-color: #eee;" onload="disableSubmit()">
 <section class="vh-85">
                  ...
                  <form class="mx-1 mx-md-4" action="<%= request.getContextPath() %>/register" method="post">
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <input type="text" id="form3Example1c" class="form-control" name="firmName"/>
                        <label class="form-label" for="form3Example1c">Your Firm Name</label>
                      </div>
                    </div>
                    ...
                    <div class="d-flex flex-row align-items-center mb-4">
                      ...
                      <div class="form-outline flex-fill mb-0">
                        <input type="text" id="form3Example4cd" class="form-control" name="contact"/>
                    ...
                    <div class="d-flex justify-content-center mx-4 mb-3 mb-lg-4">
                      <input type="submit" onclick="location.href = '${pageContext.request.contextPath}/login-company.jsp';" class="btn btn-primary btn-lg" value="Register" id="submit">
                    </div>
                  </form>
                </div>
                <div class="col-md-10 col-lg-6 col-xl-7 d-flex align-items-center order-1 order-lg-2">
                  <img src="static/images/register-img.jpg" class="img-fluid" alt="Sample image">
                </div>
              </div>
            </div>
          </div>
