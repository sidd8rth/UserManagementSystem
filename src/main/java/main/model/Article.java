...
public class Article {
	...
	public Article(int id, String article_name, int article_quantity, int article_price) {
		super();
		this.id = id;
	...
	public Article(String article_name, int article_quantity, int article_price) {
		super();
		this.article_name = article_name;
		this.article_quantity = article_quantity;
		this.article_price = article_price;
